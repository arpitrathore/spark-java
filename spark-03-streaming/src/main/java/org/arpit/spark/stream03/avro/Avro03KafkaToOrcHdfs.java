 ...
 */
public class Avro03KafkaToOrcHdfs {
    private static final String APP_NAME = Avro03KafkaToOrcHdfs.class.getName();
    ...
    public static void main(String[] args) throws Exception {
        ...
        kafkaDStream.foreachRDD(message -> {
            ...
            if (rows.count() > 0) {
                ...
                df.show();
                df.write().format("orc").mode(SaveMode.Append).save("hdfs://localhost:9000/data/docker-events-dir-orc");
                System.out.println("Data written to ORC format at : hdfs://localhost:9000/data/docker-events-dir-orc");
            }
        });
